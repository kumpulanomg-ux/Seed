...
class Config:
    ...
    PRICE = 300 
    CHANEL = -1002657820640 #ايدي القناة
    INTERVAL = 1
    CHECK = 10
    CHECKS = 30
    FR3ON ="session"#جلسة الحساب
    API_ID = 24094762 
    API_HASH = "e52291b06273213d2b39e8111cf177d4"
    BOT_TOKEN = "8097102165:AAFs1NztgDLFOsf-Y4lGbvclIgAF7uwA090" 
